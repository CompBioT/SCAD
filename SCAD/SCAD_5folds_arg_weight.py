...
tr_eva_ts_summary_path = './results'+feature+'/test_on_target_summary_5fds_fixlr.txt'
tr_eva_on_source_summary_path = './results'+feature+'/train_eval_on_source_hypers_summary_5fds_fixlr.txt'

if cell_lines == "solid":
    tr_eva_ts_summary_path = './results_solid'+feature+'/test_on_target_summary_5fds_fixlr.txt'
    ...
    for iters in range(MAX_ITER):
        ...
        for split in ls_splits:  # for each split
            ...
            for it in range(epoch):
                ...
                ## epoch_auc of target domain, recording, not used in training
